...
struct FUSION_CORE_EXPORT ExperimentRun
{
    string title;
    string description;
...
struct FUSION_CORE_EXPORT ExperimentRunResults
{
...
struct FUSION_CORE_EXPORT ExperimentResults
{
    vector<ExperimentRunResults> runResults;
};

struct FUSION_CORE_EXPORT Experiment
{
public:
